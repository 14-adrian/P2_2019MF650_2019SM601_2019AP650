...
namespace P2_2019MF650_2019SM601_2019AP650.Controllers
{
    public class departamentosController : Controller
    {
        ...
        public departamentosController(reportesDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.departamentos != null ? 
                          ...
                          Problem("Entity set 'reportesDBContext.departamentos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'reportesDBContext.departamentos'  is null.");
            }
            var departamentos = await _context.departamentos.FindAsync(id);
            if (departamentos != null)
            {
